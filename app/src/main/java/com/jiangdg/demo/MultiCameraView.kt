 ...
 */
class MultiCameraView : BaseMultiCameraView, ICameraStateCallBack{
    private lateinit var mAdapter: CameraAdapter
    private lateinit var mViewBinding: ViewMultiCameraBinding
    private val mCameraList= ArrayList<MultiCameraClient.ICamera>()
    ...
    override fun initView() {
        ...
        mViewBinding.multiCameraRv.layoutManager = GridLayoutManager(mContext, 2)
    ...
    override fun getRootView(inflater: LayoutInflater, container: ViewGroup?): View {
        mViewBinding = ViewMultiCameraBinding.inflate(inflater, container, true)
